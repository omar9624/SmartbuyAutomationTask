...
public class AddProductToCart extends Parameters {
	...
	public void addProduct() throws InterruptedException, IOException {
		...
		WebElement PriceFilterList = driver.findElement(
				By.cssSelector("div[class='facet js-facet head_price'] div[class='facet__name js-facet-name']"));
		PriceFilterList.click();

		WebElement priceListContainer = driver.findElement(By.cssSelector(
				"body > main:nth-child(10) > div:nth-child(12) > div:nth-child(1) > div:nth-child(6) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > ul:nth-child(1)"));
